...
var todoItems = [];
todoItems.push({index: 1, value: "洗澡", done: false});
todoItems.push({index: 2, value: "刷牙", done: true});
todoItems.push({index: 3, value: "洗臉", done: true});
todoItems.push({index: 4, value: "擦藥", done: false});
